...
class MethodChannelAndroidDevel extends AndroidDevelPlatform {
  ...
  Future<int> getAndroidSdkVersion() async{
    final result = await methodChannel.invokeMethod<int>('getAndroidSdkVersion');
    if(result == null){
  ...
  Future<String?> getDataDirAbsolutePath() async{
    final result = await methodChannel.invokeMethod<String>('getDataDirAbsolutePath');
    if(result == null){
  ...
  Future<String> getObbDirAbsolutePath() async{
    final result = await methodChannel.invokeMethod<String>('getObbDirAbsolutePath');
    if(result == null){
  ...
  Future<String> getFilesDirAbsolutePath() async{
    final result = await methodChannel.invokeMethod<String>('getFilesDirAbsolutePath');
    if(result == null){
  ...
  Future<String> getPackageResourcePath() async{
    final result = await methodChannel.invokeMethod<String>('getPackageResourcePath');
    if(result == null){
  ...
  Future<String> getPackageCodePath() async{
    final result = await methodChannel.invokeMethod<String>('getPackageCodePath');
    if(result == null){
